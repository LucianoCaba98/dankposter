...
public class SqsProducerService {
    ...
    public void send(MemeMessage message) {
        try {
            ...
            log.error("Failed to serialize MemeMessage: sourceSpecificId={}, source={}",
                    message.sourceSpecificId(), message.sourceIdentifier(), e);
        } catch (Exception e) {
            log.error("Failed to send MemeMessage to SQS: sourceSpecificId={}, source={}",
                    message.sourceSpecificId(), message.sourceIdentifier(), e);
        }
    }
}
